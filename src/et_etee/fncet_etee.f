*     File et_etee/fncet_etee.f : Sat Mar 18 19:45:06 2000
*
...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,net_eteeextn),pp(net_eteeextn,net_eteeextn)
      common /sp4vec/ vec(4,net_eteeextn)
*=======================================================================
*          initialization
*=======================================================================
...
*=======================================================================
      ...
      do 1000 ireg = 1 , mxreg
        ...
        call kinem_4f(net_eteeextn, xx, p, pp, yacob,nreg,ireg,jump)
...
*       ===================
        ...
        call spstr4(kreg, net_eteeextn, let_eteeag, ans, p, agc)
...
*-----------------------------------------------------------------------
 ...
 1000 continue
      call spput4(kreg, net_eteeextn, let_eteeag, p, agc)
