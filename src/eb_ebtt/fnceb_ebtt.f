*     File eb_ebtt/fnceb_ebtt.f : Sat Mar 18 19:45:05 2000
*
...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,neb_ebttextn),pp(neb_ebttextn,neb_ebttextn)
      common /sp4vec/ vec(4,neb_ebttextn)
*=======================================================================
*          initialization
*=======================================================================
...
*=======================================================================
      ...
      do 1000 ireg = 1 , mxreg
        ...
        call kinem_4f(neb_ebttextn, xx, p, pp, yacob,nreg,ireg,jump)
...
*       ===================
        ...
        call spstr4(kreg, neb_ebttextn, leb_ebttag, ans, p, agc)
...
*-----------------------------------------------------------------------
 ...
 1000 continue
      call spput4(kreg, neb_ebttextn, leb_ebttag, p, agc)
