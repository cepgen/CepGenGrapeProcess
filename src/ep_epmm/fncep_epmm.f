*     File ep_epmm/fncep_epmm.f : Sat Mar 18 19:44:58 2000
*
...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nep_epmmextn),pp(nep_epmmextn,nep_epmmextn)
      common /sp4vec/ vec(4,nep_epmmextn)
*=======================================================================
*          initialization
*=======================================================================
...
*=======================================================================
      ...
      do 1000 ireg = 1 , mxreg
        ...
        call kinem_4f(nep_epmmextn, xx, p, pp, yacob,nreg,ireg,jump)
...
*       ===================
        ...
        call spstr4(kreg, nep_epmmextn, lep_epmmag, ans, p, agc)
...
*-----------------------------------------------------------------------
 ...
 1000 continue
      call spput4(kreg, nep_epmmextn, lep_epmmag, p, agc)
