...
*-----------------------------------------------------------------------
      ...
      do j = 1, nebb_ebbmmextn
       do i = 1, nebb_ebbmmextn
        prod(i, j) = pp(i, j)
       enddo
      enddo
