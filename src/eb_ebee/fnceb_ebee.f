*     File eb_ebee/fnceb_ebee.f : Sat Mar 18 19:45:05 2000
*
...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,neb_ebeeextn),pp(neb_ebeeextn,neb_ebeeextn)
      common /sp4vec/ vec(4,neb_ebeeextn)
*=======================================================================
*          initialization
*=======================================================================
...
*=======================================================================
      ...
      do 1000 ireg = 1 , mxreg
        ...
        call kinem_4f(neb_ebeeextn, xx, p, pp, yacob,nreg,ireg,jump)
...
*       ===================
        ...
        call spstr4(kreg, neb_ebeeextn, leb_ebeeag, ans, p, agc)
...
*-----------------------------------------------------------------------
 ...
 1000 continue
      call spput4(kreg, neb_ebeeextn, leb_ebeeag, p, agc)
