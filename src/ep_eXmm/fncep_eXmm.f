*     File ep_eXmm/fncep_eXmm.f : Sat Mar 18 19:45:45 2000
*
...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nep_eXmmextn),pp(nep_eXmmextn,nep_eXmmextn)
      common /sp4vec/ vec(4,nep_eXmmextn)
*=======================================================================
*          initialization
*=======================================================================
...
*=======================================================================
      ...
      do 1000 ireg = 1 , mxreg
        ...
        call kinem_4f(nep_eXmmextn, xx, p, pp, yacob,nreg,ireg,jump)
...
*       ===================
        ...
        call spstr4(kreg, nep_eXmmextn, lep_eXmmag, ans, p, agc)
...
*-----------------------------------------------------------------------
 ...
 1000 continue
      call spput4(kreg, nep_eXmmextn, lep_eXmmag, p, agc)
