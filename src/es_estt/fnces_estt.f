*     File es_estt/fnces_estt.f : Sat Mar 18 19:45:02 2000
*
...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nes_esttextn),pp(nes_esttextn,nes_esttextn)
      common /sp4vec/ vec(4,nes_esttextn)
*=======================================================================
*          initialization
*=======================================================================
...
*=======================================================================
      ...
      do 1000 ireg = 1 , mxreg
        ...
        call kinem_4f(nes_esttextn, xx, p, pp, yacob,nreg,ireg,jump)
...
*       ===================
        ...
        call spstr4(kreg, nes_esttextn, les_esttag, ans, p, agc)
...
*-----------------------------------------------------------------------
 ...
 1000 continue
      call spput4(kreg, nes_esttextn, les_esttag, p, agc)
