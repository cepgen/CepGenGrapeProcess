*     File ed_edmm/fnced_edmm.f : Sat Mar 18 19:45:00 2000
*
...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,ned_edmmextn),pp(ned_edmmextn,ned_edmmextn)
      common /sp4vec/ vec(4,ned_edmmextn)
*=======================================================================
*          initialization
*=======================================================================
...
*=======================================================================
      ...
      do 1000 ireg = 1 , mxreg
        ...
        call kinem_4f(ned_edmmextn, xx, p, pp, yacob,nreg,ireg,jump)
