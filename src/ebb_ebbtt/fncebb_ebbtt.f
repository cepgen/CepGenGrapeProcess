...
*-----------------------------------------------------------------------
      ...
      do j = 1, nebb_ebbttextn
       do i = 1, nebb_ebbttextn
        prod(i, j) = pp(i, j)
       enddo
      enddo
...
*-----------------------------------------------------------------------
 ...
 1000 continue
      call spput4(kreg, nebb_ebbttextn, lebb_ebttag, p, agc)
