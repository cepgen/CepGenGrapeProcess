*     File ep_eXee/fncep_eXee.f : Sat Mar 18 19:45:45 2000
*
...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nep_eXeeextn),pp(nep_eXeeextn,nep_eXeeextn)
      common /sp4vec/ vec(4,nep_eXeeextn)
*=======================================================================
*          initialization
*=======================================================================
...
*=======================================================================
      ...
      do 1000 ireg = 1 , mxreg
        ...
        call kinem_4f(nep_eXeeextn, xx, p, pp, yacob,nreg,ireg,jump)
...
*       ===================
        ...
        call spstr4(kreg, nep_eXeeextn, lep_eXeeag, ans, p, agc)
...
*-----------------------------------------------------------------------
 ...
 1000 continue
      call spput4(kreg, nep_eXeeextn, lep_eXeeag, p, agc)
