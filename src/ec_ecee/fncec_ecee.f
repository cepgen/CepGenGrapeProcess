*     File ec_ecee/fncec_ecee.f : Sat Mar 18 19:45:03 2000
*
...
************************************************************************
     ...
     &                 ig(mxdim),ncall
      ...
      real*8     xx(mxdim),p(4,nec_eceeextn),pp(nec_eceeextn,nec_eceeextn)
      common /sp4vec/ vec(4,nec_eceeextn)
*=======================================================================
*          initialization
*=======================================================================
...
*=======================================================================
      ...
      do 1000 ireg = 1 , mxreg
        ...
        call kinem_4f(nec_eceeextn, xx, p, pp, yacob,nreg,ireg,jump)
...
*       ===================
        ...
        call spstr4(kreg, nec_eceeextn, lec_eceeag, ans, p, agc)
...
*-----------------------------------------------------------------------
 ...
 1000 continue
      call spput4(kreg, nec_eceeextn, lec_eceeag, p, agc)
